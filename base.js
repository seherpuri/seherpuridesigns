...
*/
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var R = function(a, b, c) {
      ...
      , T = function(a, b, c) {
        b && b.length > 0 && (b = sa(b),
        c && c.length > 0 && (b += "___" + sa(c)),
        b.length > 28 && (b = b.substr(0, 28) + (b.length - 28)),
        c = b,
        b = J(qa, "_p", K()),
        J(b, c, K())[a] = (new Date).getTime(),
        R(a, "_p", c))
    }
      , sa = function(a) {
    ...
    U.push(["jsl", function(a) {
        for (var b in a)
            if (Object.prototype.hasOwnProperty.call(a, b)) {
                var c = a[b];
                typeof c == "object" ? O[b] = J(O, b, []).concat(c) : J(O, b, c)
            }
        if (b = a.u)
            a = J(O, "us", []),
            a.push(b),
    ...
    var ua = /^(\/[a-zA-Z0-9_\-]+)+$/
      ...
      , Ca = function(a, b, c, d, e) {
        ...
        b = p;
        c = b.match(za);
        (d = b.match(Aa)) && d.length === 1 && Ba.test(b) && c && c.length === 1 || V("failed sanity: " + a);
        try {
            a = "?";
            if (e && e.length > 0) {
                c = b = 0;
      ...
      , Fa = function(a, b, c, d) {
        a = Da(a);
        xa.test(c) || V("invalid_callback");
        b = Ea(b);
        d = d && d.length ? Ea(d) : null;
        var e = function(f) {
      ...
      , Da = function(a) {
        ...
        b = "/" + c.join("/");
        ua.test(b) || V("invalid_prefix");
        c = 0;
        for (d = va.length; c < d; ++c)
            va[c].test(b) && V("invalid_prefix");
        c = W(a, "k", !0);
        d = W(a, "am");
        e = W(a, "rs");
        a = W(a, "t");
      ...
      , Ba = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/
      , Aa = /\/cb=/g
      , za = /\/\//g;
    ta.m = function(a, b, c, d) {
        (a = a[0]) || V("missing_hint");
        return "https://apis.google.com" + Fa(a, b, c, d)
    }
    ;
    var X = decodeURI("%73cript"), Ga = /^[-+_0-9\/A-Za-z]+={0,2}$/, Ha = function(a, b) {
        ...
        var a = O.nonce;
        return a !== void 0 ? a && a === String(a) && a.match(Ga) ? a : O.nonce = null : I.querySelector ? (a = I.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "",
        a && a === String(a) && a.match(Ga) ? O.nonce = a : O.nonce = null) : null : null
    }, Ka = function(a) {
        if (I.readyState != "loading")
            ...
            I.write(Y ? Y.createHTML(a) : a)
        }
    }, Ja = function(a) {
        var b = I.createElement(X);
        b.setAttribute("src", Y ? Y.createScriptURL(a) : a);
        a = Ia();
        a !== null && b.setAttribute("nonce", a);
        b.async = "true";
        (a = I.getElementsByTagName(X)[0]) ? a.parentNode.insertBefore(b, a) : (I.head || I.body || I.documentElement).appendChild(b)
    }, Ma = function(a, b, c) {
        La(function() {
            var d = b === na() ? J(N, "_", K()) : K();
            d = J(P(b), "_", d);
            a(d)
        }, c)
    }, Oa = function(a, b) {
        ...
        var H = J(P(c), "L", []).sort()
          ...
          , ra = function(w, C) {
            ...
            G.clearTimeout(q);
            H.push.apply(H, r);
            var D = ((N || {}).config || {}).update;
            D ? D(e) : e && J(O, "cu", []).push(e);
            if (C) {
                T("me0", w, L);
                try {
                    Ma(C, c, p)
        ...
        if (r.length) {
            ...
            if (r.length) {
                ...
                ;
                a = Ca(c, r, "gapi." + S, l, Sa);
                l.push.apply(l, r);
                T("ml0", r, L);
                b.sync || G.___gapisync ? Ka(a) : Ja(a)
            } else
                u[v](ka)
        } else
            ra(r) && d && d()
    ...
    pa.bs0 = window.gapi._bs || (new Date).getTime();
    R("bs0");
    pa.bs1 = (new Date).getTime();
    R("bs1");
    ...
    window.gapi.load("", {
        ...
        _c: {
            ...
            jsl: {
                ...
                h: "m;/_/scs/abc-static/_/js/k=gapi.lb.en._ShUtMH1OvQ.O/am=AABA/d=1/rs=AHpOoo9sEd_Wjj_xEtgO8qX69P7hAZI9cg/m=__features__",
